...
const navItems = [
  ...
  { label: 'Log Aktivitas', path: '/logs', icon: LogOut },
  ...
  return (
    <aside className="h-screen w-[260px] shrink-0 bg-white text-slate-800 flex flex-col shadow-xl z-20 border-r border-slate-200">
      ...
      <div className="px-6 py-8 border-t border-white/5">
        <button 
          onClick={logout}
          className="w-full flex items-center gap-4 px-5 py-4 rounded-2xl text-sm font-bold text-red-100 hover:bg-red-500/10 hover:text-red-400 transition-all group"
        >
